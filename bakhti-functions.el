...
(defun bakhti/kill-and-retry-line ()
...
(defun bakhti/kill-region-or-backward-word ()
  (interactive)
  (if (region-active-p)
      (kill-region (region-beginning) (region-end))
    (backward-kill-word 1)))

(defun bakhti/kill-to-beginning-of-line ()
  (interactive)
  (kill-region (save-excursion (beginning-of-line) (point))
               (point)))

(defun bakhti/open-line-below ()
  (interactive)
  (end-of-line)
  (newline)
  (indent-for-tab-command))

(defun bakhti/open-line-above ()
  (interactive)
  (beginning-of-line)
  (newline)
  (forward-line -1)
...
(defun bakhti/open-line-and-indent ()
  (interactive)
  (newline-and-indent)
  (end-of-line 0))

(defun bakhti/new-line-in-between ()
  (interactive)
  (newline)
  (save-excursion
    (newline)
...
(defun bakhti/goto-line-with-feedback ()
...
(defun bakhti/get-ansible-modules ()
...
(defun bakhti/show-ansible-doc (module)
...
(defun bakhti/mode-line-in-header ()
  (interactive)
...
(provide 'bakhti-functions)
;; Local Variables:
;; mode: emacs-lisp
;; mode: allout
;; outline-regexp: "^;;;_\\([,. ]+\\)"
;; End:
;;; bakhti-functions.el ends here
